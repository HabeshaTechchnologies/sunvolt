  ...
  var drJs = {
        ...
        var swiper = new Swiper(".banner-slider-eight", {
          ...
          pagination: {
            ...
            renderBullet: function (index, className) {
              ...
              return (
                '<span class="' + className + '">' + serialNumber + "</span>"
              );
            },
          },
        });
    ...
    vedioActivation: function (e) {
      $("#play-video, .play-video").on("click", function (e) {
        ...
        $(".video-overlay").append(
          '<iframe width="560" height="315" src="https://www.youtube.com/embed/Giek094C_l4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>'
        );
      });
    ...
    backToTopInit: function () {
      $(document).ready(function () {
        ...
        // The rest of the code can remain outside the if statement
        var offset = 50;
        var duration = 550;
