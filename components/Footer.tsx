...
const Footer = (props: Props) => {
  ...
  return (
    <div>
      <div className="rts-footer-one footer-bg-two">
              ...
              <div className="single-footer-one-wrapper two">
                <div className="single-footer-component first">
                  ...
                  <div className="body mt--45">
                    <p className="disc" dangerouslySetInnerHTML={{ __html: t('desc') }}>
                    </p>
                ...
                <div className="single-footer-component">
                  <div className="title-area">
                    <h5 className="title">{t('usefulLinks')}</h5>
                  </div>
                  <div className="body">
                  ...
                  <div className="pages-footer">
                    <ul>
                      ...
                      <li>
                        <a href="service-details.html">
                          <i className="fa-regular fa-chevron-right"></i>
                          <p>Turbines Services</p>
                        </a>
                      </li>
                      <li>
                        <a href="service-details.html">
                          <i className="fa-regular fa-chevron-right"></i>
                          <p>Hydropower Plants</p>
                        </a>
                      </li>
                      <li>
                        <a href="service-details.html">
                          <i className="fa-regular fa-chevron-right"></i>
                          <p>Fossil Resources</p>
                        </a>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="body">
                    ...
                    <div className="footer-contact-wrapper-2">
                      ...
                      <div className="contact-single">
                        ...
                        <div className="info-content ml-dec-5">
                          ...
                          <a href="tel:+251935012620 ">
                            <h6 className="title">+251935012620 </h6>
                          </a>
                          <a href="tel:+251953781482 ">
                            <h6 className="title">+251953781482 </h6>
                          </a>
                          <span>{t('callUs')}</span>
                        </div>
                      </div>
                    ...
                    <!-- single contact area start --> */}
                      <div className="contact-single">
                        ...
                        <div className="info-content">
                          ...
                          <a href="mailto:sales@sunvolt.com">
                            <h6 className="title">sales@sunvolt.com {""}</h6>
                          </a>
                          <span>{t('emailUs')}</span>
                        </div>
                      </div>
                    ...
                    <!-- single contact area start --> */}
                      <div className="contact-single">
                        ...
                        <div className="info-content">
                          <a href="#">
                            <h6 className="title" dangerouslySetInnerHTML={{ __html: t('addressTitle') }}>
                            </h6>
                          </a>
                          <span>{t('addressSub')}</span>
                        </div>
                      </div>
                      {/* <!-- single contact area start --> */}
                      ...
                      <div className="contact-single">
                        <div className="icon">
                          ...
                          >
                            <path
                              d="M20 4H4C2.89543 4 2 4.89543 2 6V18C2 19.1046 2.89543 20 4 20H20C21.1046 20 22 19.1046 22 18V6C22 4.89543 21.1046 4 20 4ZM20 6L12 11L4 6H20ZM4 18V8L12 13L20 8V18H4Z"
                              fill="#4AAB3D"
                            />
                          </svg>
                        </div>
                        <div className="info-content">
                          <a href="#">
                            <h6 className="title" dangerouslySetInnerHTML={{ __html: t('poBox') }}>
                            </h6>
                          </a>
